...
import {
  LayoutDashboard, CalendarDays, FileText, LogOut,
  Calendar, Menu, X, Bell, ChevronDown, User,
} from "lucide-react";
import { useAuth } from "../context/AuthContext";

const navItems = [
  { to: "/staff/dashboard", icon: LayoutDashboard, label: "My Dashboard" },
  { to: "/staff/schedule",  icon: CalendarDays,    label: "My Schedule" },
  { to: "/staff/leaves",    icon: FileText,        label: "My Leaves" },
...
export function StaffLayout() {
  ...
  const notifications = [
    { msg: `Your leave (Mar 1–3) was approved`, time: "1 hr ago", dot: "bg-green-400" },
    { msg: "You are assigned Night Shift on Mar 5", time: "3 hrs ago", dot: "bg-blue-400" },
    { msg: "Reminder: Morning shift tomorrow at 6:00 AM", time: "5 hrs ago", dot: "bg-yellow-400" },
  ];
      ...
      `}>
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-gray-100">
          ...
          <div>
            ...
            <p className="text-gray-400 text-xs leading-tight">Staff Portal</p>
          </div>
        ...
        <div className="px-4 pt-4 pb-1">
          <div className="flex items-center gap-2 px-3 py-2 bg-green-50 rounded-lg">
            ...
            <span className="text-xs font-semibold text-green-700">Staff Member</span>
          </div>
        </div>
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  {label}
                  {isActive && <span className="ml-auto w-1.5 h-1.5 bg-green-600 rounded-full" />}
                </>
              )}
            </NavLink>
          ))}
        ...
        <div className="px-3 py-4 border-t border-gray-100">
          <div className="flex items-center gap-3 px-3 py-2">
            ...
            <div className="min-w-0">
              <p className="text-sm text-gray-900 font-medium truncate">{user?.name || "Staff User"}</p>
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 cursor-pointer hover:bg-gray-100 rounded-lg px-2 py-1.5 transition">
              ...
              <div className="hidden sm:block">
                <p className="text-sm text-gray-900 font-medium leading-tight">{user?.name?.split(" ")[0] || "Staff"}</p>
